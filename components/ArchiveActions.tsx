...
export function ArchiveActions({ placeId, closedStatus, isArchived, compact = false }: Props) {
  ...
  const buttonClass = compact
    ? "rounded-md border border-stone-300 px-3 py-2 text-sm font-medium disabled:opacity-50"
    : "rounded-md border border-stone-300 px-4 py-2 text-sm font-medium disabled:opacity-50";
